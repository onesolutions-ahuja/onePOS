...
const customer = read("../app/src/components/modals/CustomerFormModal.jsx");
const supplier = read("../app/src/pages/suppliers/SupplierFormModal.jsx");
const store = read("../app/src/pages/stores/StoresAdmin.jsx");
const user = read("../app/src/pages/settings/UserFormModal.jsx");
