...
const canonicalEditors = [
  "src/pages/products/ProductFormModal.jsx",
  "src/components/modals/CustomerFormModal.jsx",
  "src/pages/suppliers/SupplierFormModal.jsx",
  "src/pages/settings/UserFormModal.jsx",
];
...
test("3C: shared metadata form cannot inject a page-owned save implementation", () => {
  const source = read("src/components/platform/StandardObjectFormModal.jsx");
...
test("3C: customer and supplier lifecycle toggles use canonical record commands", () => {
  const customer = read("src/pages/customers/CustomersAdmin.jsx");
  const supplier = read("src/pages/suppliers/SuppliersAdmin.jsx");
...
test("3C: record page action buttons execute only through registered metadata button runtime", () => {
  const source = read("src/pages/settings/Platform/ObjectPage.jsx");
...
test("3C: workflow and approval remain registered platform metadata, not object-page business logic", () => {
  ...
  const route = read("routes/platform.js");
