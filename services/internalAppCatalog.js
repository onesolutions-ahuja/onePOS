const CATALOG = [
  ...
  },
  {
    key: "loyalty",
    name: "Loyalty Core",
    description: "Canonical loyalty configuration, balances, activity and rules.",
    route: "/app/customers",
    permissions: ["customer.view", "loyalty.adjust", "settings.manage"],
    storeScoped: false,
    category: "Foundation",
    packageType: "FOUNDATION",
    technical: true,
  ...
  {
    key: "finance_core",
    packageKey: "finance_core",
    name: "Finance Core",
    description: "Hidden financial ledger and supplier-accounting foundation.",
    route: "/app/suppliers",
    permissions: ["purchase.view", "purchase.edit", "inventory.adjust", "reports.payments.view"],
    storeScoped: false,
    category: "Foundation",
    packageType: "FOUNDATION",
    technical: true,
  ...
  {
    key: "supplier_core",
    packageKey: "supplier_core",
    name: "Supplier Core",
    description: "Canonical supplier identity and supplier-product sourcing metadata.",
    route: "/app/suppliers",
    permissions: ["inventory.view", "inventory.adjust", "purchase.view"],
    storeScoped: false,
    category: "Catalogue & Supply",
    packageType: "FOUNDATION",
    technical: true,
  ...
  },
  {
    ...
    visibility: "HIDDEN",
    systemOnly: true,
    dependencies: ["products", "inventory", { packageKey: "customers", optional: true }],
