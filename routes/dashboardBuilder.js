  ...
  async function runComponent(req, component, dashboardFilters) {
    ...
    try {
      ...
      if (definition.dataSource === "platform_object") {
        ...
        built = buildPlatformObjectQuery(definition, context.object, context.fields, req.user.companyId, 1000, { storeId: req.user.storeId }, context.relationships);
      ...
      return {
        id: component.id,
        type: component.type,
        error: error.message || "Unable to load this component",
      };
    }
  }
