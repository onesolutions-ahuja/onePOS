  ...
  router.post(
    ...
    async (req, res) => {
      ...
      try {
        ...
        manufacturing = validateExpiry(manufacturingDate);
        if (manufacturing && manufacturing.statusCode) throw Object.assign(new Error(manufacturing.message), { statusCode: manufacturing.statusCode });
        if (manufacturing && expiry && manufacturing > expiry) throw Object.assign(new Error("Manufacturing date cannot be after expiry date"), { statusCode: 400 });
      } catch (error) {
